...
export default function Home() {
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            setCounter(localStorage.getItem("kaosrunning") ? parseInt(localStorage.getItem("kaosrunning")!) : 100);
    ...
    const startRandomizer = () => {
        ...
        localStorage.setItem("kaosrunning", (tunaiCounter - 1).toString());
    }
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-[#FEDFB6]">
                <h1 className="text-6xl font-bold mb-6 text-[#401606]">Undian 1 Unit Kaos Running</h1>
                <div className="mb-10 relative">
                    <img src="/kaosrunning.png" alt="Kaos Running" className="w-60 h-60" />
                </div>
                {!isAnimating ?
