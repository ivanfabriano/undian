...
export default function Home() {
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            setCounter(localStorage.getItem("tws") ? parseInt(localStorage.getItem("tws")!) : 100);
    ...
    const startRandomizer = () => {
        ...
        localStorage.setItem("tws", (tunaiCounter - 1).toString());
    }
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-[#FEDFB6]">
                <h1 className="text-6xl font-bold mb-6 text-[#401606]">Undian 2 Coffee Cup</h1>
                <div className="mb-10 relative">
                    <img src="/coffecup.jpeg" alt="Cash 200K" className="w-60 h-60" />
                </div>
                {!isAnimating ?
