...
export default function Home() {
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            setCounter(localStorage.getItem("mouse") ? parseInt(localStorage.getItem("mouse")!) : 100);
    ...
    const startRandomizer = () => {
        ...
        localStorage.setItem("mouse", (tunaiCounter - 1).toString());
    }
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-[#FEDFB6]">
                <h1 className="text-6xl font-bold mb-6 text-[#401606]">Undian 1 Unit Mouse</h1>
                <div className="mb-10 relative">
                    <img src="/mouse.jpg" alt="Mouse" className="w-60 h-60" />
                </div>
                {!isAnimating ?
