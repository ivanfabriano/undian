...
export default function Home() {
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            setCounter(localStorage.getItem("smarttv") ? parseInt(localStorage.getItem("smarttv")!) : 100);
    ...
    const startRandomizer = () => {
        ...
        localStorage.setItem("smarttv", (tunaiCounter - 1).toString());
    }
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-[#FEDFB6]">
                <h1 className="text-6xl font-bold mb-6 text-[#401606]">Undian 1 Unit Dinner Set</h1>
                <div className="mb-10 relative">
                    <img src="/dinnerset.jpeg" alt="Cash 200K" className="w-60 h-60" />
                </div>
                {!isAnimating ?
